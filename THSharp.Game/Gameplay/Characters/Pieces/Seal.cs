...
using THSharp.Game.Gameplay.Characters.TouhosuPlayers.DrawableTouhosuPlayers;
using THSharp.Game.Gameplay.Characters.VitaruPlayers.DrawableVitaruPlayers;
using THSharp.Game.Graphics;

namespace THSharp.Game.Gameplay.Characters.Pieces
{
